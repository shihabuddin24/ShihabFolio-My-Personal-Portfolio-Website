<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <ul class="footer-list">
                    ...
                    <li><i class="fa-solid fa-business-time me-1"></i><span class="text-secondary">Sat - Thu: 8:00 AM - 5:00 PM</span></li>
                </ul>
            </div>
            <div class="col-lg-4 col-md-6">
        ...
        <div class="footer-bottom text-center mt-4">
            <p class="text-secondary">© 2026 Shihab Uddin. All rights reserved.</p>
        </div>
    </div>
</footer>
